...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0005_auto_20210316_2254'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'Новый заказ'), ('in_progress', 'Заказ в обработке'), ('is_ready', 'Заказ готов'), ('completed', 'Заказ выолнен')], default='new', max_length=100, verbose_name='Статус заказа')),
